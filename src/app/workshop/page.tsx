...
export default function WorkshopPage() {
  ...
  const [variant, setVariant] = useState<WorkshopVariant>("180"); // Центральная карточка по умолчанию
  ...
  // Callback для отслеживания видимости CourseSelection
  ...
  return (
    <main className="min-h-screen bg-[#1a2744] text-white">
      ...
      {/* Variant Selector - показывается только когда CourseSelection не видна */}
      <AnimatePresence>
        {showStickyBar && (
          <motion.div
