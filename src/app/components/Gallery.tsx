...
export default function Gallery({ heading, before, after, counter, cta }: GalleryProps) {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-6 flex items-center justify-center gap-8">
                  <span className="text-xl font-bold text-[#1a2744] md:text-2xl">{before}</span>
                  ...
                  <span className="text-xl font-bold text-[#1a2744] md:text-2xl">{after}</span>
                </div>
              </motion.div>
            </AnimatePresence>
          </motion.div>
