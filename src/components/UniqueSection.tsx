        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-t from-[#dfba74]/30 to-transparent" />
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="font-bold text-[#be800c]">
            ...
            >
              ...
              <span className="font-semibold text-[#be800c]">
