    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#1a2744] via-[#0f1829] to-[#1a2744]">
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-40 h-80 w-80 rounded-full bg-[#dfba74]/5 blur-3xl end-[-10rem]"
        />
        <motion.div
          animate={{ scale: [1.2, 1, 1.2], rotate: [0, -90, 0] }}
          transition={{ duration: 25, repeat: Infinity }}
          className="absolute -bottom-40 h-96 w-96 rounded-full bg-[#be800c]/5 blur-3xl start-[-10rem]"
        />
      </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-center md:gap-12">
          ...
          >
            ...
            >
              ...
              <span className="bg-gradient-to-r from-[#fcd384] via-[#dfba74] to-[#be800c] bg-clip-text text-transparent">
                {t('titleAccent')}
              </span>
            ...
            <motion.div
              ...
              className="space-y-3"
            >
              <p className="text-lg md:text-xl" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
                {t('subtitle')}
              </p>
            </motion.div>
            <motion.div
          ...
          >
            <Image src="/images/hero.png" alt="MitoDerm Workshop" fill className="object-cover" priority />
          </motion.div>
        </div>
      </div>
    </section>
